...
{
    internal class BookLoanManagementServices
    {
        private int _count = 0;
        private List<BookLoan> users = new List<BookLoan>();
        ...
        public string BorrowBook(string nama, string email, string nomorKeangotaan)
        {
            User user = new User();
            user.Id = ++_count;
            user.Nama = nama;
